...
# App for publish
library(shiny)
suppressMessages(install.packages("fmsb"))
library(fmsb)
library(tidyverse)
suppressMessages(install.packages("lpSolve"))
library(lpSolve)
library(readxl)
library(bigrquery)
#library(aws.s3)
...
library(plotly)
suppressMessages(install.packages("mice"))
library(mice)
...
server <- function(input, output, session) {
  ...
  observeEvent(input$mybutton, {  
    ...
    Ealy_INDEX_BLUP = read.csv("C:/Users/gmgwr/OneDrive - Bayer/Desktop/R shiny V2/Ealy_INDEX_BLUP.csv")
